...
def main(fold_no, folds_count, imgs_dir, masks_dir, batch_size, epochs, experiment_name):
    ...
    train_gen = DataGenerator(train_imgs, train_masks, batch_size, [96, 96], 3, training=True)
    val_gen = DataGenerator(val_imgs, val_masks, batch_size, [96, 96], 3)

    net = ResnetCls([96, 96, 3], f'{experiment_name}_{fold_no}')
