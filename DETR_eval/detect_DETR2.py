...
LR = 2e-5
EPOCHS = 20
TEST_DIR = Path('C:/Users/user/Downloads/DFUC2022_test_release')
...
def eval_fn(data_loader, model, criterion, device):
    ...
    output_path = Path('results_DETR_test')
    ...
    with torch.no_grad():
        ...
        for step, (images, targets, image_ids) in enumerate(tk0):
            ...
            for img_num, img in enumerate(images):
                ...
                i += 1
                np.save(f"C:/Users/user/Downloads/upload_ulcer/upload_ulcer/boxes_test/{i}.npy", box_save)
